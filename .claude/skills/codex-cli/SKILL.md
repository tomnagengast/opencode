...
3. **Non-interactive exec mode** - Use `codex --yolo exec --skip-git-repo-check -o ./specs/logs/$(date +%Y-%m-%d)-codex-<spec_slug>.md "<task>"` for automation, logging and session resumption
